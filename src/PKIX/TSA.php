...
class TSA
{
	...
	public static function getTimestamp( $data, $caBundlePath = null, $tsaURL = null )
	{
		...
		$tsq = Sequence::create( [
			...
			Sequence::create( [
				Sequence::create( [
					ObjectIdentifier::create( \PKIX\OID::getOIDFromName( self::hashAlg ) ),
					NullElement::create()
				] ),
		...
		if ( ! ( $oid = asObjectIdentifier( $timestampToken->at(1) ) ) || $oid->getIdentifier() != \PKIX\OID::getOIDFromName('id-signedData') )
		{
		...
		if ( ! $tst || 
			...
			$tstInfoOID->getIdentifier() != \PKIX\OID::getOIDFromName('id-ct-TSTInfo') )
		{
